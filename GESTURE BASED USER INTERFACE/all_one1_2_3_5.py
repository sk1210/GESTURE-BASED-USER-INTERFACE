...
def paint():
    ...
    while True:
        ...
        x,y=p_rect.left,p_rect.top
        event_get()
        touch_box=pygame.draw.rect(DISPLAY,WHITE,(p_rect.left-50,p_rect.top+50,100,100))
        '''open cv'''
